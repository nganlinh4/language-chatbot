...
await main();
The Search-as-a-tool functionality also enables multi-turn searches and multi-tool queries. Combining Search with function calling is not yet supported.
